...
<pre>
$ bin\plugin -install ddani/transport-zeromq/0.0.3
</pre>

Elasticsearch automatically install the plugin:

<pre>
-> Installing ddani/transport-zeromq/0.0.3...
Trying https://github.com/downloads/ddani/transport-zeromq/transport-zeromq-0.0.3.zip...
Downloading ..........DONE
